...
import { Model, ModelViewerSettings, AuthState } from '../types';
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        if (response.ok) {
          // If we can access models, we're authenticated
          setAuthState({ isAuthenticated: true, user: { role: 'client' } });
          loadModels();
        } else {
          router.push('/login');
        }
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                No 3D models have been uploaded yet. Please contact your administrator.
              </p>
            </div>
          </div>
        ) : (
